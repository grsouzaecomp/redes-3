...
DB_NAME = "server1.db"  # Altere para server2.db ou server3.db nos outros servidores
PORT = 5000  # Altere para 5001 ou 5002
WS_PORT = 8000  # Porta para WebSocket (altere para 8001 ou 8002 nos outros servidores)
